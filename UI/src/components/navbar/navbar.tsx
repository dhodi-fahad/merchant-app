...
const Navbar: React.FC = () => {
    return(
        <>
            <header className="fixed right-0 left-64 z-40 top-0 ">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        <div className="flex justify-start items-center">
                            ...
                            <a href="" className="flex mr-4">
                                ...
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-purple-900">The Selling App</span>
                            </a>
